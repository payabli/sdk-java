...
@JsonDeserialize(builder = ListApplicationsRequest.Builder.class)
public final class ListApplicationsRequest {
    ...
    public static final class Builder {
        ...
        public ListApplicationsRequest build() {
            return new ListApplicationsRequest(fromRecord, limitRecord, parameters, sortBy, additionalProperties);
        }
    }
}
