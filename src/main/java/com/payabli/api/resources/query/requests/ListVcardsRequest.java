...
@JsonDeserialize(builder = ListVcardsRequest.Builder.class)
public final class ListVcardsRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListVcardsRequest && equalTo((ListVcardsRequest) other);
    }
    ...
    private boolean equalTo(ListVcardsRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListVcardsRequest other) {
        ...
        public ListVcardsRequest build() {
            return new ListVcardsRequest(fromRecord, limitRecord, parameters, sortBy, additionalProperties);
        }
    }
}
