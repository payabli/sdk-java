...
@JsonDeserialize(builder = ListChargebacksRequest.Builder.class)
public final class ListChargebacksRequest {
    ...
    private ListChargebacksRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListChargebacksRequest && equalTo((ListChargebacksRequest) other);
    }
    ...
    private boolean equalTo(ListChargebacksRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListChargebacksRequest other) {
        ...
        public ListChargebacksRequest build() {
            return new ListChargebacksRequest(fromRecord, limitRecord, parameters, sortBy, additionalProperties);
        }
    }
}
