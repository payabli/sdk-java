...
@JsonDeserialize(builder = ListBatchDetailsRequest.Builder.class)
public final class ListBatchDetailsRequest {
    ...
    private ListBatchDetailsRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListBatchDetailsRequest && equalTo((ListBatchDetailsRequest) other);
    }
    ...
    private boolean equalTo(ListBatchDetailsRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListBatchDetailsRequest other) {
        ...
        public ListBatchDetailsRequest build() {
            return new ListBatchDetailsRequest(fromRecord, limitRecord, parameters, sortBy, additionalProperties);
        }
    }
}
