...
@JsonDeserialize(builder = ListTransactionsOrgRequest.Builder.class)
public final class ListTransactionsOrgRequest {
    ...
    private ListTransactionsOrgRequest(
     ...
     * <li><code>source</code> (in, nin, eq, ne, ct, nct)</li>
     ...
     * <li>`AchHolderType`` (ct, nct, in, nin, eq, and ne)</li>
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListTransactionsOrgRequest && equalTo((ListTransactionsOrgRequest) other);
    }
    ...
    private boolean equalTo(ListTransactionsOrgRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListTransactionsOrgRequest other) {
        ...
        public ListTransactionsOrgRequest build() {
            return new ListTransactionsOrgRequest(fromRecord, limitRecord, parameters, sortBy, additionalProperties);
        }
    }
}
