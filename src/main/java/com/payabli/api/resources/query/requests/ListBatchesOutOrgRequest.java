...
@JsonDeserialize(builder = ListBatchesOutOrgRequest.Builder.class)
public final class ListBatchesOutOrgRequest {
    ...
    private ListBatchesOutOrgRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListBatchesOutOrgRequest && equalTo((ListBatchesOutOrgRequest) other);
    }
    ...
    private boolean equalTo(ListBatchesOutOrgRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListBatchesOutOrgRequest other) {
        ...
        public ListBatchesOutOrgRequest build() {
            return new ListBatchesOutOrgRequest(fromRecord, limitRecord, parameters, sortBy, additionalProperties);
        }
    }
}
