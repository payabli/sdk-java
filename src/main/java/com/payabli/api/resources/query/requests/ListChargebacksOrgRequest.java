...
@JsonDeserialize(builder = ListChargebacksOrgRequest.Builder.class)
public final class ListChargebacksOrgRequest {
    ...
    private ListChargebacksOrgRequest(
     ...
     * &lt;/Info&gt; See <a href="/developers/developer-guides/pay-ops-reporting-engine-overview#filters-and-conditions-reference">Filters and Conditions Reference</a> for help.</p>
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListChargebacksOrgRequest && equalTo((ListChargebacksOrgRequest) other);
    }
    ...
    private boolean equalTo(ListChargebacksOrgRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListChargebacksOrgRequest other) {
        ...
        public ListChargebacksOrgRequest build() {
            return new ListChargebacksOrgRequest(fromRecord, limitRecord, parameters, sortBy, additionalProperties);
        }
    }
}
