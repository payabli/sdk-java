...
@JsonDeserialize(builder = ListCustomersOrgRequest.Builder.class)
public final class ListCustomersOrgRequest {
    ...
    private ListCustomersOrgRequest(
     ...
     * <li><code>firstname</code> (ne, eq, ct, nct)</li>
     * <li><code>lastname</code> (ne, eq, ct, nct)</li>
     * <li><code>name</code> (ct, nct)</li>
     ...
     * <li><code>shippingaddress</code> (ne, eq, ct, nct)</li>
     * <li><code>shippingcity</code> (ne, eq, ct, nct)</li>
     * <li><code>shippingcountry</code> (ne, eq, ct, nct)</li>
     * <li><code>shippingzip</code> (ne, eq, ct, nct)</li>
     * <li><code>shippingstate</code> (ne, eq, ct, nct)</li>
     * <li><code>phone</code> (ne, eq, ct, nct)</li>
     * <li><code>email</code> (ne, eq, ct, nct)</li>
     * <li><code>company</code> (ne, eq, ct, nct)</li>
     * <li><code>username</code> (ne, eq, ct, nct)</li>
     ...
     * <code>balance(gt)=20</code> will return all records with a balance greater than 20.00.</p>
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListCustomersOrgRequest && equalTo((ListCustomersOrgRequest) other);
    }
    ...
    private boolean equalTo(ListCustomersOrgRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListCustomersOrgRequest other) {
        ...
        public ListCustomersOrgRequest build() {
            return new ListCustomersOrgRequest(fromRecord, limitRecord, parameters, sortBy, additionalProperties);
        }
    }
}
