...
@JsonDeserialize(builder = ListPaypointsRequest.Builder.class)
public final class ListPaypointsRequest {
     ...
     * <li><code>lastModified</code> (gt, ge, lt, le, eq, ne)</li>
     ...
     * <li><code>orgParentname</code>  (ct, nct, in, nin)</li>
     * <li><code>boardingId</code> (eq, ne)</li>
     * <li><code>entryName</code>  (ct, nct)</li>
     * <li><code>externalOrgID</code> (ct, nct)</li>
     * </ul>
     ...
     * </ul>
     * <p>Example: <code>dbaname(ct)=hoa</code> returns all records with a <code>dbaname</code> containing &quot;hoa&quot;</p>
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListPaypointsRequest && equalTo((ListPaypointsRequest) other);
    }
    ...
    private boolean equalTo(ListPaypointsRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListPaypointsRequest other) {
        ...
        public ListPaypointsRequest build() {
            return new ListPaypointsRequest(fromRecord, limitRecord, parameters, sortBy, additionalProperties);
        }
    }
}
