...
@JsonDeserialize(builder = PayabliApiResponse11.Builder.class)
public final class PayabliApiResponse11 {
    private final Optional<Boolean> isSuccess;

    private final Optional<String> pageIdentifier;

    private final Optional<PayabliApiResponse11ResponseData> responseData;

    private final Optional<String> responseText;

    private final Map<String, Object> additionalProperties;

    private PayabliApiResponse11(
            Optional<Boolean> isSuccess,
            Optional<String> pageIdentifier,
            Optional<PayabliApiResponse11ResponseData> responseData,
    ...
    public Optional<PayabliApiResponse11ResponseData> getResponseData() {
        return responseData;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PayabliApiResponse11 && equalTo((PayabliApiResponse11) other);
    }
    ...
    private boolean equalTo(PayabliApiResponse11 other) {
    ...
    public static final class Builder {
        ...
        private Optional<PayabliApiResponse11ResponseData> responseData = Optional.empty();
        ...
        public Builder from(PayabliApiResponse11 other) {
        ...
        public Builder responseData(Optional<PayabliApiResponse11ResponseData> responseData) {
            this.responseData = responseData;
            return this;
        }

        public Builder responseData(PayabliApiResponse11ResponseData responseData) {
        ...
        public PayabliApiResponse11 build() {
            return new PayabliApiResponse11(
