...
@JsonDeserialize(builder = PageSetting.Builder.class)
public final class PageSetting {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PageSetting && equalTo((PageSetting) other);
    }
    ...
    private boolean equalTo(PageSetting other) {
    ...
    public static final class Builder {
        ...
        public Builder from(PageSetting other) {
