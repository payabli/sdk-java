...
@JsonDeserialize(builder = ApplicationDataOdp.Builder.class)
public final class ApplicationDataOdp {
    ...
    private final double payoutAverageTicketAmount;

    private final double payoutCreditLimit;

    private final double payoutHighTicketAmount;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ApplicationDataOdp && equalTo((ApplicationDataOdp) other);
    }
    ...
    private boolean equalTo(ApplicationDataOdp other) {
        return services.equals(other.services)
                ...
                && payoutAverageMonthlyVolume == other.payoutAverageMonthlyVolume
                && payoutAverageTicketAmount == other.payoutAverageTicketAmount
                && payoutCreditLimit == other.payoutCreditLimit
                && payoutHighTicketAmount == other.payoutHighTicketAmount
    ...
    public static PayoutAverageMonthlyVolumeStage builder() {
        return new Builder();
    }

    public interface PayoutAverageMonthlyVolumeStage {
        PayoutAverageTicketAmountStage payoutAverageMonthlyVolume(double payoutAverageMonthlyVolume);

        Builder from(ApplicationDataOdp other);
    }

    public interface PayoutAverageTicketAmountStage {
        PayoutCreditLimitStage payoutAverageTicketAmount(double payoutAverageTicketAmount);
    }

    public interface PayoutCreditLimitStage {
        PayoutHighTicketAmountStage payoutCreditLimit(double payoutCreditLimit);
    }

    public interface PayoutHighTicketAmountStage {
        SignerStage payoutHighTicketAmount(double payoutHighTicketAmount);
    }
    ...
    public static final class Builder
            implements PayoutAverageMonthlyVolumeStage,
                    PayoutAverageTicketAmountStage,
                    PayoutCreditLimitStage,
                    PayoutHighTicketAmountStage,
                    SignerStage,
                    _FinalStage {
        private double payoutAverageMonthlyVolume;

        private double payoutAverageTicketAmount;

        private double payoutCreditLimit;
        ...
        @java.lang.Override
        public Builder from(ApplicationDataOdp other) {
        ...
        @java.lang.Override
        @JsonSetter("payoutAverageMonthlyVolume")
        public PayoutAverageTicketAmountStage payoutAverageMonthlyVolume(double payoutAverageMonthlyVolume) {
            this.payoutAverageMonthlyVolume = payoutAverageMonthlyVolume;
            return this;
        }

        @java.lang.Override
        @JsonSetter("payoutAverageTicketAmount")
        public PayoutCreditLimitStage payoutAverageTicketAmount(double payoutAverageTicketAmount) {
            this.payoutAverageTicketAmount = payoutAverageTicketAmount;
            return this;
        }

        @java.lang.Override
        @JsonSetter("payoutCreditLimit")
        public PayoutHighTicketAmountStage payoutCreditLimit(double payoutCreditLimit) {
            this.payoutCreditLimit = payoutCreditLimit;
            return this;
        }

        @java.lang.Override
        @JsonSetter("payoutHighTicketAmount")
        public SignerStage payoutHighTicketAmount(double payoutHighTicketAmount) {
            this.payoutHighTicketAmount = payoutHighTicketAmount;
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage services(Services services) {
        ...
        public _FinalStage services(Optional<Services> services) {
            this.services = services;
            return this;
        }

        @java.lang.Override
        public ApplicationDataOdp build() {
            return new ApplicationDataOdp(
                    services,
                    annualRevenue,
                    attachments,
                    baddress,
