...
@JsonDeserialize(builder = ApplePayPaypointRegistrationData.Builder.class)
public final class ApplePayPaypointRegistrationData {
    ...
    private final Optional<AppleWalletData> walletData;

    private final Map<String, Object> additionalProperties;

    private ApplePayPaypointRegistrationData(
            Optional<String> entry,
            Optional<Boolean> isEnabled,
            Optional<String> walletType,
            Optional<AppleWalletData> walletData,
    ...
    public Optional<AppleWalletData> getWalletData() {
        return walletData;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ApplePayPaypointRegistrationData && equalTo((ApplePayPaypointRegistrationData) other);
    }
    ...
    private boolean equalTo(ApplePayPaypointRegistrationData other) {
    ...
    public static final class Builder {
        ...
        private Optional<AppleWalletData> walletData = Optional.empty();
        ...
        public Builder from(ApplePayPaypointRegistrationData other) {
        ...
        public Builder walletData(Optional<AppleWalletData> walletData) {
            this.walletData = walletData;
            return this;
        }

        public Builder walletData(AppleWalletData walletData) {
            this.walletData = Optional.ofNullable(walletData);
            return this;
        }

        public ApplePayPaypointRegistrationData build() {
            return new ApplePayPaypointRegistrationData(entry, isEnabled, walletType, walletData, additionalProperties);
        }
    }
}
