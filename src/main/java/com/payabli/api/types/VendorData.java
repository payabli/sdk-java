...
@JsonDeserialize(builder = VendorData.Builder.class)
public final class VendorData {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VendorData && equalTo((VendorData) other);
    }
    ...
    private boolean equalTo(VendorData other) {
    ...
    public static final class Builder {
        ...
        public Builder from(VendorData other) {
