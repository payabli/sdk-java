...
@JsonDeserialize(builder = QueryResponseTransactions.Builder.class)
public final class QueryResponseTransactions {
    ...
    private QueryResponseTransactions(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof QueryResponseTransactions && equalTo((QueryResponseTransactions) other);
    }
    ...
    private boolean equalTo(QueryResponseTransactions other) {
    ...
    public static final class Builder {
        ...
        public Builder from(QueryResponseTransactions other) {
        ...
        public QueryResponseTransactions build() {
            return new QueryResponseTransactions(records, summary, additionalProperties);
        }
    }
}
