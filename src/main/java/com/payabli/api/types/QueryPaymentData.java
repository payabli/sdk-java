...
@JsonDeserialize(builder = QueryPaymentData.Builder.class)
public final class QueryPaymentData {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof QueryPaymentData && equalTo((QueryPaymentData) other);
    }
    ...
    private boolean equalTo(QueryPaymentData other) {
    ...
    public static final class Builder {
        ...
        public Builder from(QueryPaymentData other) {
        ...
        public Builder signatureData(Optional<String> signatureData) {
            this.signatureData = signatureData;
            return this;
        }
        ...
        public QueryPaymentData build() {
            return new QueryPaymentData(
                    accountExp,
                    accountId,
                    accountType,
                    accountZip,
