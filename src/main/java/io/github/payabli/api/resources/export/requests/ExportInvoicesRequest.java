...
@JsonDeserialize(builder = ExportInvoicesRequest.Builder.class)
public final class ExportInvoicesRequest {
     ...
     * </ul>
     * <p>Example: <code>totalAmount(gt)=20</code> returns all records with <code>totalAmount</code> greater than 20.00</p>
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExportInvoicesRequest && equalTo((ExportInvoicesRequest) other);
    }
    ...
    private boolean equalTo(ExportInvoicesRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ExportInvoicesRequest other) {
        ...
        public ExportInvoicesRequest build() {
            return new ExportInvoicesRequest(columnsExport, fromRecord, limitRecord, parameters, additionalProperties);
        }
    }
}
