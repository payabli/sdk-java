...
@JsonDeserialize(builder = GetEntryConfigResponse.Builder.class)
public final class GetEntryConfigResponse {
    ...
    private GetEntryConfigResponse(
            boolean isSuccess,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetEntryConfigResponse && equalTo((GetEntryConfigResponse) other);
    }
    ...
    private boolean equalTo(GetEntryConfigResponse other) {
    ...
    public interface IsSuccessStage {
        ...
        Builder from(GetEntryConfigResponse other);
    }
    ...
    public static final class Builder implements IsSuccessStage, ResponseTextStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(GetEntryConfigResponse other) {
        ...
        @java.lang.Override
        public GetEntryConfigResponse build() {
            return new GetEntryConfigResponse(
