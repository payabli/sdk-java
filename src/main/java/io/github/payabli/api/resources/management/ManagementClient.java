...
public class ManagementClient {
    ...
    private final RawManagementClient rawClient;

    public ManagementClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
        this.rawClient = new RawManagementClient(clientOptions);
    }

    /**
     * Get responses with HTTP metadata like headers
     */
    public RawManagementClient withRawResponse() {
     ...
     */
    public VerifyAccountDetailsResponse verifyAccountDetails(String entry, VerifyAccountDetailsRequest request) {
        return this.rawClient.verifyAccountDetails(entry, request).body();
    }
     ...
     * <p>Requires <code>inboundpayments_create</code> or <code>outboundpayments_create</code> permission.</p>
     */
    public VerifyAccountDetailsResponse verifyAccountDetails(
