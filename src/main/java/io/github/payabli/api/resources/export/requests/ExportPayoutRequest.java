...
@JsonDeserialize(builder = ExportPayoutRequest.Builder.class)
public final class ExportPayoutRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExportPayoutRequest && equalTo((ExportPayoutRequest) other);
    }
    ...
    private boolean equalTo(ExportPayoutRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ExportPayoutRequest other) {
        ...
        public ExportPayoutRequest build() {
            return new ExportPayoutRequest(columnsExport, fromRecord, limitRecord, parameters, additionalProperties);
        }
    }
}
