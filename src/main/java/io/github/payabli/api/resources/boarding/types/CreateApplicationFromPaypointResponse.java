...
@JsonDeserialize(builder = CreateApplicationFromPaypointResponse.Builder.class)
public final class CreateApplicationFromPaypointResponse {
    ...
    private final Optional<CreateApplicationFromPaypointResponseData> responseData;

    private final Map<String, Object> additionalProperties;

    private CreateApplicationFromPaypointResponse(
            Optional<Integer> responseCode,
            Optional<String> pageIdentifier,
            Optional<Long> roomId,
            Optional<Boolean> isSuccess,
            String responseText,
            Optional<CreateApplicationFromPaypointResponseData> responseData,
    ...
    public Optional<CreateApplicationFromPaypointResponseData> getResponseData() {
        return responseData;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateApplicationFromPaypointResponse
                && equalTo((CreateApplicationFromPaypointResponse) other);
    }
    ...
    private boolean equalTo(CreateApplicationFromPaypointResponse other) {
    ...
    public interface ResponseTextStage {
        ...
        Builder from(CreateApplicationFromPaypointResponse other);
    }

    public interface _FinalStage {
        CreateApplicationFromPaypointResponse build();
        ...
        _FinalStage responseData(Optional<CreateApplicationFromPaypointResponseData> responseData);

        _FinalStage responseData(CreateApplicationFromPaypointResponseData responseData);
    }
    ...
    public static final class Builder implements ResponseTextStage, _FinalStage {
        ...
        private Optional<CreateApplicationFromPaypointResponseData> responseData = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateApplicationFromPaypointResponse other) {
        ...
        @java.lang.Override
        public _FinalStage responseData(CreateApplicationFromPaypointResponseData responseData) {
        ...
        public _FinalStage responseData(Optional<CreateApplicationFromPaypointResponseData> responseData) {
            this.responseData = responseData;
            return this;
        }
        ...
        @java.lang.Override
        public CreateApplicationFromPaypointResponse build() {
            return new CreateApplicationFromPaypointResponse(
