...
@JsonDeserialize(builder = ExportCustomersRequest.Builder.class)
public final class ExportCustomersRequest {
    ...
    private ExportCustomersRequest(
     ...
     * balance(gt)=20 return all records with balance greater than 20.00</p>
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExportCustomersRequest && equalTo((ExportCustomersRequest) other);
    }
    ...
    private boolean equalTo(ExportCustomersRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ExportCustomersRequest other) {
        ...
        public ExportCustomersRequest build() {
            return new ExportCustomersRequest(columnsExport, fromRecord, limitRecord, parameters, additionalProperties);
        }
    }
}
