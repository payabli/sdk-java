...
@JsonDeserialize(builder = ListLineItemsRequest.Builder.class)
public final class ListLineItemsRequest {
     ...
     * <li><code>commodityCode</code> (ne, eq, ct, nct)</li>
     * <li><code>createdDate</code> (gt, ge, lt, le, eq, ne)</li>
     * <li><code>description</code> (ne, eq, ct, nct)</li>
     * <li><code>externalPaypointID</code> (ct, nct, ne, eq)</li>
     * <li><code>mode</code> (eq, ne)</li>
     ...
     * <li><code>quantity</code> (gt, ge, lt, le, eq, ne)</li>
     * <li><code>uom</code> (ne, eq, ct, nct)</li>
     ...
     * </ul>
     * <p>Example: name(ct)=john return all records with name containing john</p>
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListLineItemsRequest && equalTo((ListLineItemsRequest) other);
    }
    ...
    private boolean equalTo(ListLineItemsRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListLineItemsRequest other) {
        ...
        public ListLineItemsRequest build() {
            return new ListLineItemsRequest(fromRecord, limitRecord, parameters, sortBy, additionalProperties);
        }
    }
}
