...
@JsonDeserialize(builder = ExportVendorsOrgRequest.Builder.class)
public final class ExportVendorsOrgRequest {
    ...
    private ExportVendorsOrgRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExportVendorsOrgRequest && equalTo((ExportVendorsOrgRequest) other);
    }
    ...
    private boolean equalTo(ExportVendorsOrgRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ExportVendorsOrgRequest other) {
        ...
        public ExportVendorsOrgRequest build() {
            return new ExportVendorsOrgRequest(
