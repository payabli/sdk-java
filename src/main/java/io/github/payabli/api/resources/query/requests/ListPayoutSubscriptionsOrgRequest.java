...
@JsonDeserialize(builder = ListPayoutSubscriptionsOrgRequest.Builder.class)
public final class ListPayoutSubscriptionsOrgRequest {
    ...
    private ListPayoutSubscriptionsOrgRequest(
     ...
     * <p>For example:</p>
     * <p>--url https://api-sandbox.payabli.com/api/Query/payoutsubscriptions/org/236?parameters=totalAmount(gt)=1000&amp;limitRecord=20</p>
     * <p>should become:</p>
     * <p>--url https://api-sandbox.payabli.com/api/Query/payoutsubscriptions/org/236?totalAmount(gt)=1000&amp;limitRecord=20
     * &lt;/Info&gt;
     * See <a href="/developers/developer-guides/pay-ops-reporting-engine-overview#filters-and-conditions-reference">Filters and Conditions Reference</a> for more information.
     ...
     * <li><code>payaccountLastfour</code> (ct, nct)</li>
     ...
     * <li><code>orgName</code> (ne, eq, ct, nct, nin, in)</li>
     * <li><code>parentOrgId</code> (ne, eq, nin, in)</li>
     * <li><code>subscriptionId</code> (eq, ne)</li>
     ...
     * <li><code>vendorNumber</code> (ne, eq, ct, nct)</li>
     * <li><code>name</code> (ne, eq, ct, nct)</li>
     * <li><code>phone</code> (ne, eq, ct, nct)</li>
     * <li><code>email</code> (ne, eq, ct, nct)</li>
     * <li><code>address</code> (ne, eq, ct, nct)</li>
     * <li><code>remitAddress</code> (ct, nct)</li>
     * <li><code>city</code> (ne, eq, ct, nct)</li>
     * <li><code>state</code> (ne, eq, ct, nct)</li>
     * <li><code>country</code> (ne, eq, ct, nct)</li>
     * <li><code>zip</code> (ne, eq, ct, nct)</li>
     * </ul>
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListPayoutSubscriptionsOrgRequest && equalTo((ListPayoutSubscriptionsOrgRequest) other);
    }
    ...
    private boolean equalTo(ListPayoutSubscriptionsOrgRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListPayoutSubscriptionsOrgRequest other) {
        ...
        public ListPayoutSubscriptionsOrgRequest build() {
            return new ListPayoutSubscriptionsOrgRequest(
