...
public class RawTaptopayClient {
    protected final ClientOptions clientOptions;

    public RawTaptopayClient(ClientOptions clientOptions) {
     ...
     */
    public PayabliApiClientHttpResponse<TapToPayActivationChallengeResponse> activationChallenge(
