...
@JsonDeserialize(builder = ListUsersOrgRequest.Builder.class)
public final class ListUsersOrgRequest {
     ...
     * <li><code>role.xxx</code>  (ne, eq, ct, nct) where xxx is the role field: <code>roleLabel</code> or <code>roleValue</code></li>
     * </ul>
     ...
     * </ul>
     * <p>Example: <code>name(ct)=john</code>  return all records with name containing 'john'.</p>
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListUsersOrgRequest && equalTo((ListUsersOrgRequest) other);
    }
    ...
    private boolean equalTo(ListUsersOrgRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListUsersOrgRequest other) {
        ...
        public ListUsersOrgRequest build() {
            return new ListUsersOrgRequest(fromRecord, limitRecord, parameters, sortBy, additionalProperties);
        }
    }
}
