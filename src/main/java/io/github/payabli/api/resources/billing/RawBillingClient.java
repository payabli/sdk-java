...
public class RawBillingClient {
     ...
     */
    public PayabliApiClientHttpResponse<BillingProfileQueryResponse> listProfiles(long orgId) {
     ...
     * without it gets <code>403 Forbidden</code>.</p>
     */
    public PayabliApiClientHttpResponse<BillingProfileQueryResponse> listProfiles(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new PayabliApiClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, BillingProfileQueryResponse.class),
                        response);
            }
            try {
     ...
     */
    public PayabliApiClientHttpResponse<BillingProfileResponse> getProfile(
