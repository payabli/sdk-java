...
@JsonDeserialize(builder = ExportVendorsRequest.Builder.class)
public final class ExportVendorsRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExportVendorsRequest && equalTo((ExportVendorsRequest) other);
    }
    ...
    private boolean equalTo(ExportVendorsRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ExportVendorsRequest other) {
        ...
        public ExportVendorsRequest build() {
            return new ExportVendorsRequest(columnsExport, fromRecord, limitRecord, parameters, additionalProperties);
        }
    }
}
