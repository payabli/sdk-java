...
public class AsyncPaymentLinkClient {
     ...
     */
    public CompletableFuture<PayabliApiResponsePaymentLinks> patchOutPaymentLink(String paylinkId) {
        return this.rawClient.patchOutPaymentLink(paylinkId).thenApply(response -> response.body());
    }

    /**
     * Partially updates a Pay Out payment link's content, expiration date, and/or status. Use this to modify the payment page configuration, extend or change the expiration, or cancel a link. Updating the expiration date of an expired link reactivates it to Active status.
     */
    public CompletableFuture<PayabliApiResponsePaymentLinks> patchOutPaymentLink(
            String paylinkId, RequestOptions requestOptions) {
        return this.rawClient.patchOutPaymentLink(paylinkId, requestOptions).thenApply(response -> response.body());
    }
    ...
    public CompletableFuture<PayabliApiResponsePaymentLinks> patchOutPaymentLink(
        ...
        return this.rawClient.patchOutPaymentLink(paylinkId, request).thenApply(response -> response.body());
    }
     ...
     */
    public CompletableFuture<PayabliApiResponsePaymentLinks> updatePayLinkOutFromId(String paylinkId) {
        return this.rawClient.updatePayLinkOutFromId(paylinkId).thenApply(response -> response.body());
    }

    /**
     * Updates the payment page content for a Pay Out payment link. Use this to change the branding, messaging, payment methods offered, or other page configuration.
     */
    public CompletableFuture<PayabliApiResponsePaymentLinks> updatePayLinkOutFromId(
            String paylinkId, RequestOptions requestOptions) {
        return this.rawClient.updatePayLinkOutFromId(paylinkId, requestOptions).thenApply(response -> response.body());
    }
    ...
    public CompletableFuture<PayabliApiResponsePaymentLinks> updatePayLinkOutFromId(
        ...
        return this.rawClient.updatePayLinkOutFromId(paylinkId, request).thenApply(response -> response.body());
    }
