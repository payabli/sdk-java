...
@JsonDeserialize(builder = SubStatsRequest.Builder.class)
public final class SubStatsRequest {
    private final Optional<Map<String, Optional<String>>> parameters;

    private final Map<String, Object> additionalProperties;

    private SubStatsRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SubStatsRequest && equalTo((SubStatsRequest) other);
    }
    ...
    private boolean equalTo(SubStatsRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(SubStatsRequest other) {
        ...
        public SubStatsRequest build() {
            return new SubStatsRequest(parameters, additionalProperties);
        }
    }
}
