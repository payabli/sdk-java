...
@JsonDeserialize(builder = ListTransferDetailsOutRequest.Builder.class)
public final class ListTransferDetailsOutRequest {
    ...
    private ListTransferDetailsOutRequest(
     ...
     * <li><code>transactionId</code> (eq, ne, in, nin)</li>
     * <li><code>category</code> (eq, ne, ct, nct)</li>
     * <li><code>type</code> (eq, ne, in, nin)</li>
     * <li><code>method</code> (eq, ne, in, nin)</li>
     * <li><code>walletType</code> (eq, ne, in, nin)</li>
     * <li><code>splitFundingAmount</code> (gt, ge, lt, le, eq, ne)</li>
     * </ul>
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListTransferDetailsOutRequest && equalTo((ListTransferDetailsOutRequest) other);
    }
    ...
    private boolean equalTo(ListTransferDetailsOutRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListTransferDetailsOutRequest other) {
        ...
        /**
         * <p>Collection of field names, conditions, and values used to filter the query. See <a href="/developers/developer-guides/pay-ops-reporting-engine-overview#filters-and-conditions-reference">Filters and Conditions Reference</a> for more information.
         * &lt;Info&gt;
        ...
        public ListTransferDetailsOutRequest build() {
            return new ListTransferDetailsOutRequest(fromRecord, limitRecord, parameters, sortBy, additionalProperties);
        }
    }
}
