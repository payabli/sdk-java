...
@JsonDeserialize(builder = ListVcardsTransactionsOrgRequest.Builder.class)
public final class ListVcardsTransactionsOrgRequest {
    ...
    private ListVcardsTransactionsOrgRequest(
     ...
     * <p>For example:</p>
     * <p>--url https://api-sandbox.payabli.com/api/Query/vcardsTransactions/org/236?parameters=transactionAmount(gt)=100&amp;limitRecord=20</p>
     * <p>should become:</p>
     * <p>--url https://api-sandbox.payabli.com/api/Query/vcardsTransactions/org/236?transactionAmount(gt)=100&amp;limitRecord=20
     * &lt;/Info&gt;</p>
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListVcardsTransactionsOrgRequest && equalTo((ListVcardsTransactionsOrgRequest) other);
    }
    ...
    private boolean equalTo(ListVcardsTransactionsOrgRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListVcardsTransactionsOrgRequest other) {
        ...
        public ListVcardsTransactionsOrgRequest build() {
            return new ListVcardsTransactionsOrgRequest(
