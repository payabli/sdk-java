...
@JsonDeserialize(builder = AddDeviceResponse.Builder.class)
public final class AddDeviceResponse implements IPayabliApiResponseGeneric2Part {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AddDeviceResponse && equalTo((AddDeviceResponse) other);
    }
    ...
    private boolean equalTo(AddDeviceResponse other) {
    ...
    public interface ResponseTextStage {
        ...
        Builder from(AddDeviceResponse other);
    }
    ...
    public static final class Builder implements ResponseTextStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(AddDeviceResponse other) {
        ...
        public AddDeviceResponse build() {
            return new AddDeviceResponse(isSuccess, responseText, pageIdentifier, responseData, additionalProperties);
        }
    }
}
