...
@JsonDeserialize(builder = ListBoardingLinksRequest.Builder.class)
public final class ListBoardingLinksRequest {
    ...
    private ListBoardingLinksRequest(
     ...
     * <li><code>referenceName</code> (ct, nct)</li>
     * <li><code>acceptRegister</code> (eq, ne)</li>
     * <li><code>acceptAuth</code> (eq, ne)</li>
     * <li><code>templateCode</code> (ct, nct)</li>
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListBoardingLinksRequest && equalTo((ListBoardingLinksRequest) other);
    }
    ...
    private boolean equalTo(ListBoardingLinksRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListBoardingLinksRequest other) {
        ...
        public ListBoardingLinksRequest build() {
            return new ListBoardingLinksRequest(fromRecord, limitRecord, parameters, sortBy, additionalProperties);
        }
    }
}
