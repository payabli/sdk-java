...
@JsonDeserialize(builder = AddResponseResponse.Builder.class)
public final class AddResponseResponse implements IPayabliApiResponseGeneric2Part {
    ...
    /**
     * @return If <code>isSuccess</code> = true, this contains the chargeback identifier. If <code>isSuccess</code> = false, this contains the reason for the error.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AddResponseResponse && equalTo((AddResponseResponse) other);
    }
    ...
    private boolean equalTo(AddResponseResponse other) {
    ...
    public interface ResponseTextStage {
        ...
        Builder from(AddResponseResponse other);
    }
    ...
    public interface _FinalStage {
        ...
        /**
         * <p>If <code>isSuccess</code> = true, this contains the chargeback identifier. If <code>isSuccess</code> = false, this contains the reason for the error.</p>
         */
    ...
    public static final class Builder implements ResponseTextStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(AddResponseResponse other) {
