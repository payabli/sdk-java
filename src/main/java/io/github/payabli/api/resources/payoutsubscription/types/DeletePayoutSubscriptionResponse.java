...
@JsonDeserialize(builder = DeletePayoutSubscriptionResponse.Builder.class)
public final class DeletePayoutSubscriptionResponse {
    ...
    private DeletePayoutSubscriptionResponse(
    ...
    /**
     * @return If <code>isSuccess</code> = true, this contains the identifier of the payout subscription.
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeletePayoutSubscriptionResponse && equalTo((DeletePayoutSubscriptionResponse) other);
    }
    ...
    private boolean equalTo(DeletePayoutSubscriptionResponse other) {
    ...
    public interface ResponseTextStage {
        ...
        Builder from(DeletePayoutSubscriptionResponse other);
    }

    public interface _FinalStage {
        DeletePayoutSubscriptionResponse build();
        ...
        /**
         * <p>If <code>isSuccess</code> = true, this contains the identifier of the payout subscription.</p>
         * <p>If <code>isSuccess</code> = false, this contains the reason for the failure.</p>
         */
    ...
    public static final class Builder implements ResponseTextStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(DeletePayoutSubscriptionResponse other) {
        ...
        @java.lang.Override
        public DeletePayoutSubscriptionResponse build() {
            return new DeletePayoutSubscriptionResponse(isSuccess, responseData, responseText, additionalProperties);
        }
