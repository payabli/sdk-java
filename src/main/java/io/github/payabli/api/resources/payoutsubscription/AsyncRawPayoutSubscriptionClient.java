...
public class AsyncRawPayoutSubscriptionClient {
     ...
     */
    public CompletableFuture<PayabliApiClientHttpResponse<AddPayoutSubscriptionResponse>> createPayoutSubscription(
    ...
    public CompletableFuture<PayabliApiClientHttpResponse<AddPayoutSubscriptionResponse>> createPayoutSubscription(
        ...
        CompletableFuture<PayabliApiClientHttpResponse<AddPayoutSubscriptionResponse>> future =
     ...
     */
    public CompletableFuture<PayabliApiClientHttpResponse<GetPayoutSubscriptionResponse>> getPayoutSubscription(
            long id) {
    ...
    public CompletableFuture<PayabliApiClientHttpResponse<GetPayoutSubscriptionResponse>> getPayoutSubscription(
        ...
        CompletableFuture<PayabliApiClientHttpResponse<GetPayoutSubscriptionResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
     ...
     */
    public CompletableFuture<PayabliApiClientHttpResponse<UpdatePayoutSubscriptionResponse>> updatePayoutSubscription(
            long id) {
    ...
    public CompletableFuture<PayabliApiClientHttpResponse<UpdatePayoutSubscriptionResponse>> updatePayoutSubscription(
        ...
        CompletableFuture<PayabliApiClientHttpResponse<UpdatePayoutSubscriptionResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
     ...
     */
    public CompletableFuture<PayabliApiClientHttpResponse<DeletePayoutSubscriptionResponse>> deletePayoutSubscription(
            long id) {
    ...
    public CompletableFuture<PayabliApiClientHttpResponse<DeletePayoutSubscriptionResponse>> deletePayoutSubscription(
        ...
        CompletableFuture<PayabliApiClientHttpResponse<DeletePayoutSubscriptionResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
