...
public class AsyncBoardingClient {
     ...
     */
    public CompletableFuture<CreateApplicationFromPaypointResponse> addServiceToPaypointFromApp(
            CreateApplicationFromPaypointRequest request) {
        return this.rawClient.addServiceToPaypointFromApp(request).thenApply(response -> response.body());
    }
     ...
     */
    public CompletableFuture<QueryBoardingAppsListResponse> getApplicationsByPaypointId(long paypointId) {
        return this.rawClient.getApplicationsByPaypointId(paypointId).thenApply(response -> response.body());
    }

    /**
     * Returns all boarding applications associated with a specific paypoint, including those created through the multi-product boarding flow. Use this endpoint to track underwriting progress across multiple service additions or to build reporting views. See the <a href="/guides/pay-ops-developer-boarding-multi-product">Multi-product boarding</a> guide for the full flow.
     */
    public CompletableFuture<QueryBoardingAppsListResponse> getApplicationsByPaypointId(
