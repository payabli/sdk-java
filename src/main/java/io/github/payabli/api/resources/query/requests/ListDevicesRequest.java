...
public final class ListDevicesRequest {
     ...
     * <p>For example:</p>
     * <p>--url https://api-sandbox.payabli.com/api/Query/devices/8cfec329267?parameters=status=1&amp;limitRecord=20</p>
     * <p>should become:</p>
     * <p>--url https://api-sandbox.payabli.com/api/Query/devices/8cfec329267?status=1&amp;limitRecord=20
     * &lt;/Info&gt;</p>
