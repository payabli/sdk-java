...
public class AsyncRawMoneyOutClient {
     ...
     */
    public CompletableFuture<PayabliApiClientHttpResponse<AuthCapturePayoutResponse>> authorizeOut(
    ...
    public CompletableFuture<PayabliApiClientHttpResponse<AuthCapturePayoutResponse>> authorizeOut(
        ...
        CompletableFuture<PayabliApiClientHttpResponse<AuthCapturePayoutResponse>> future = new CompletableFuture<>();
     ...
     */
    public CompletableFuture<PayabliApiClientHttpResponse<CaptureAllOutResponse>> cancelAllOut(List<String> request) {
     ...
     * Cancels an array of payout transactions.
     */
    public CompletableFuture<PayabliApiClientHttpResponse<CaptureAllOutResponse>> cancelAllOut(
        ...
        CompletableFuture<PayabliApiClientHttpResponse<CaptureAllOutResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<PayabliApiClientHttpResponse<PayabliApiResponse0000>> cancelOutGet(String referenceId) {
     ...
     * Cancel a payout transaction by ID.
     */
    public CompletableFuture<PayabliApiClientHttpResponse<PayabliApiResponse0000>> cancelOutGet(
        ...
        CompletableFuture<PayabliApiClientHttpResponse<PayabliApiResponse0000>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     * Cancel a payout transaction by ID.
     */
    public CompletableFuture<PayabliApiClientHttpResponse<PayabliApiResponse0000>> cancelOutDelete(String referenceId) {
     ...
     * Cancel a payout transaction by ID.
     */
    public CompletableFuture<PayabliApiClientHttpResponse<PayabliApiResponse0000>> cancelOutDelete(
            String referenceId, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("MoneyOut/cancel")
     ...
     */
    public CompletableFuture<PayabliApiClientHttpResponse<CaptureAllOutResponse>> captureAllOut(List<String> body) {
     ...
     * Captures an array of authorized payout transactions for settlement. The maximum number of transactions that can be captured in a single request is 500.
     */
    public CompletableFuture<PayabliApiClientHttpResponse<CaptureAllOutResponse>> captureAllOut(
     ...
     */
    public CompletableFuture<PayabliApiClientHttpResponse<AuthCapturePayoutResponse>> captureOut(String referenceId) {
     ...
     * <p>If a velocity fraud alert is triggered, the endpoint returns a <code>202</code> response with <code>responseCode</code> <code>9051</code>, and the capture is held for risk review rather than rejected. If a risk policy blocks the transaction, the endpoint returns a <code>422</code> response with <code>responseCode</code> <code>9005</code>, a terminal rejection.</p>
     */
    public CompletableFuture<PayabliApiClientHttpResponse<AuthCapturePayoutResponse>> captureOut(
            String referenceId, RequestOptions requestOptions) {
     ...
     */
    public CompletableFuture<PayabliApiClientHttpResponse<AuthCapturePayoutResponse>> payout(AuthorizePayoutBody body) {
     ...
     * <p>If the capture fails, the payout stays authorized. Retry the capture with <code>GET /MoneyOut/capture/{referenceId}</code> using the <code>referenceId</code> from the error response rather than resubmitting, which would create a second payout. See the <a href="/guides/pay-out-developer-payouts-manage#authorize-and-capture-in-one-call">Manage payouts guide</a> for details.</p>
     */
    public CompletableFuture<PayabliApiClientHttpResponse<AuthCapturePayoutResponse>> payout(
            AuthorizePayoutBody body, RequestOptions requestOptions) {
     ...
     * <p>If the capture fails, the payout stays authorized. Retry the capture with <code>GET /MoneyOut/capture/{referenceId}</code> using the <code>referenceId</code> from the error response rather than resubmitting, which would create a second payout. See the <a href="/guides/pay-out-developer-payouts-manage#authorize-and-capture-in-one-call">Manage payouts guide</a> for details.</p>
     */
    public CompletableFuture<PayabliApiClientHttpResponse<AuthCapturePayoutResponse>> payout(PayoutRequest request) {
     ...
     */
    public CompletableFuture<PayabliApiClientHttpResponse<BillDetailResponse>> payoutDetails(String transId) {
     ...
     * Returns details for a processed money out transaction.
     */
    public CompletableFuture<PayabliApiClientHttpResponse<BillDetailResponse>> payoutDetails(
        ...
        CompletableFuture<PayabliApiClientHttpResponse<BillDetailResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<PayabliApiClientHttpResponse<VCardGetResponse>> vCardGet(String cardToken) {
     ...
     * Retrieves vCard details for a single card in an entrypoint.
     */
    public CompletableFuture<PayabliApiClientHttpResponse<VCardGetResponse>> vCardGet(
        ...
        CompletableFuture<PayabliApiClientHttpResponse<VCardGetResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<PayabliApiClientHttpResponse<RenewVCardResponse>> renewVCard(
            String cardToken, RenewVCardRequest request) {
    ...
    public CompletableFuture<PayabliApiClientHttpResponse<RenewVCardResponse>> renewVCard(
        ...
        CompletableFuture<PayabliApiClientHttpResponse<RenewVCardResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new PayabliApiClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, RenewVCardResponse.class),
                                response));
                        return;
                    }
                    try {
     ...
     */
    public CompletableFuture<PayabliApiClientHttpResponse<OperationResult>> sendVCardLink(
    ...
    public CompletableFuture<PayabliApiClientHttpResponse<OperationResult>> sendVCardLink(
        ...
        CompletableFuture<PayabliApiClientHttpResponse<OperationResult>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<PayabliApiClientHttpResponse<String>> getCheckImage(String assetName) {
     ...
     * The check image is only available for payouts that have been processed.
     */
    public CompletableFuture<PayabliApiClientHttpResponse<String>> getCheckImage(
     ...
     */
    public CompletableFuture<PayabliApiClientHttpResponse<ReissuePayoutResponse>> reissueOut(
    ...
    public CompletableFuture<PayabliApiClientHttpResponse<ReissuePayoutResponse>> reissueOut(
        ...
        CompletableFuture<PayabliApiClientHttpResponse<ReissuePayoutResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new PayabliApiClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ReissuePayoutResponse.class),
                                response));
                        return;
                    }
                    try {
