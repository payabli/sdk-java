...
import io.github.payabli.api.resources.moneyout.types.CaptureAllOutResponse;
import io.github.payabli.api.resources.moneyout.types.OperationResult;
import io.github.payabli.api.resources.moneyout.types.VCardGetResponse;
...
import io.github.payabli.api.types.PayabliApiResponse11;
...
public class RawMoneyOutClient {
     ...
     */
    public PayabliApiHttpResponse<PayabliApiResponse11> authorizeOut(RequestOutAuthorize request) {
     ...
     * Authorizes transaction for payout. Authorized transactions aren't flagged for settlement until captured. Use <code>referenceId</code> returned in the response to capture the transaction.
     */
    public PayabliApiHttpResponse<PayabliApiResponse11> authorizeOut(
    ...
    public PayabliApiHttpResponse<PayabliApiResponse0000> cancelOut(String referenceId, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new PayabliApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PayabliApiResponse0000.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            try {
     ...
     */
    public PayabliApiHttpResponse<PayabliApiResponse11> captureOut(String referenceId) {
     ...
     * Captures a single authorized payout transaction by ID.
     */
    public PayabliApiHttpResponse<PayabliApiResponse11> captureOut(String referenceId, CaptureOutRequest request) {
     ...
     * Captures a single authorized payout transaction by ID.
     */
    public PayabliApiHttpResponse<PayabliApiResponse11> captureOut(
    ...
    public PayabliApiHttpResponse<BillDetailResponse> payoutDetails(String transId, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new PayabliApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), BillDetailResponse.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            try {
                switch (response.code()) {
