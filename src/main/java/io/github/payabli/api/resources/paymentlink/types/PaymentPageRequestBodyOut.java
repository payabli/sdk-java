...
@JsonDeserialize(builder = PaymentPageRequestBodyOut.Builder.class)
public final class PaymentPageRequestBodyOut {
    ...
    private final Optional<MethodElementOut> paymentMethods;

    private final Optional<HeaderElement> review;

    private final Optional<Element> bills;

    private final Optional<PagelinkSetting> settings;

    private final Map<String, Object> additionalProperties;

    private PaymentPageRequestBodyOut(
            ...
            Optional<MethodElementOut> paymentMethods,
            Optional<HeaderElement> review,
            Optional<Element> bills,
    ...
    /**
     * @return Payment methods section of payment link page. Use this to configure which payout methods (ACH, vCard, check) are offered to the vendor.
     */
    @JsonProperty("paymentMethods")
    public Optional<MethodElementOut> getPaymentMethods() {
    ...
    /**
     * @return Bills section of payment link page.
     */
    @JsonProperty("bills")
    public Optional<Element> getBills() {
        return bills;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PaymentPageRequestBodyOut && equalTo((PaymentPageRequestBodyOut) other);
    }
    ...
    private boolean equalTo(PaymentPageRequestBodyOut other) {
    ...
    public static final class Builder {
        ...
        private Optional<MethodElementOut> paymentMethods = Optional.empty();

        private Optional<HeaderElement> review = Optional.empty();

        private Optional<Element> bills = Optional.empty();
        ...
        public Builder from(PaymentPageRequestBodyOut other) {
        ...
        /**
         * <p>Payment methods section of payment link page. Use this to configure which payout methods (ACH, vCard, check) are offered to the vendor.</p>
         */
        @JsonSetter(value = "paymentMethods", nulls = Nulls.SKIP)
        public Builder paymentMethods(Optional<MethodElementOut> paymentMethods) {
            this.paymentMethods = paymentMethods;
            return this;
        }

        public Builder paymentMethods(MethodElementOut paymentMethods) {
        ...
        /**
         * <p>Bills section of payment link page.</p>
         */
        @JsonSetter(value = "bills", nulls = Nulls.SKIP)
        public Builder bills(Optional<Element> bills) {
            this.bills = bills;
            return this;
        }

        public Builder bills(Element bills) {
        ...
        public PaymentPageRequestBodyOut build() {
            return new PaymentPageRequestBodyOut(
                    contactUs,
                    logo,
                    messageBeforePaying,
                    notes,
