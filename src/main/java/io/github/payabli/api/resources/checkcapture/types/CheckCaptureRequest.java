 ...
 */
package io.github.payabli.api.resources.checkcapture.types;
...
@JsonDeserialize(builder = CheckCaptureRequest.Builder.class)
public final class CheckCaptureRequest {
    ...
    /**
     * @return Base64-encoded image of the front of the check. Must be JPEG or PNG format and less than 1MB. Image must show the entire check clearly with no partial, blurry, or illegible portions.
     */
    ...
    /**
     * @return Base64-encoded image of the back of the check. Must be JPEG or PNG format and less than 1MB. Image must show the entire check clearly with no partial, blurry, or illegible portions.
     */
    ...
    /**
     * @return Check amount in cents (maximum 32-bit integer value). For example, $125.50 is represented as 12550.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CheckCaptureRequest && equalTo((CheckCaptureRequest) other);
    }
    ...
    private boolean equalTo(CheckCaptureRequest other) {
    ...
    public interface EntryPointStage {
        ...
        Builder from(CheckCaptureRequest other);
    }

    public interface FrontImageStage {
        /**
         * <p>Base64-encoded image of the front of the check. Must be JPEG or PNG format and less than 1MB. Image must show the entire check clearly with no partial, blurry, or illegible portions.</p>
         */
    ...
    public interface RearImageStage {
        /**
         * <p>Base64-encoded image of the back of the check. Must be JPEG or PNG format and less than 1MB. Image must show the entire check clearly with no partial, blurry, or illegible portions.</p>
         */
    ...
    public interface CheckAmountStage {
        /**
         * <p>Check amount in cents (maximum 32-bit integer value). For example, $125.50 is represented as 12550.</p>
         */
        _FinalStage checkAmount(int checkAmount);
    }

    public interface _FinalStage {
        CheckCaptureRequest build();
    }
    ...
    public static final class Builder
        ...
        @java.lang.Override
        public Builder from(CheckCaptureRequest other) {
        ...
        @java.lang.Override
        public CheckCaptureRequest build() {
            return new CheckCaptureRequest(entryPoint, frontImage, rearImage, checkAmount, additionalProperties);
        }
    }
}
