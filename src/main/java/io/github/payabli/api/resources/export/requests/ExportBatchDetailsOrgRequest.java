...
@JsonDeserialize(builder = ExportBatchDetailsOrgRequest.Builder.class)
public final class ExportBatchDetailsOrgRequest {
    ...
    private ExportBatchDetailsOrgRequest(
     ...
     * </ul>
     * <p>Example: <code>amount(gt)=20</code> return all records with amount greater than 20.00</p>
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExportBatchDetailsOrgRequest && equalTo((ExportBatchDetailsOrgRequest) other);
    }
    ...
    private boolean equalTo(ExportBatchDetailsOrgRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ExportBatchDetailsOrgRequest other) {
        ...
        public ExportBatchDetailsOrgRequest build() {
            return new ExportBatchDetailsOrgRequest(
