...
@JsonDeserialize(builder = ExportOrganizationsRequest.Builder.class)
public final class ExportOrganizationsRequest {
    ...
    private ExportOrganizationsRequest(
     ...
     * <li><code>contactName</code> (ct, nct, eq, ne)</li>
     * <li><code>contactTitle</code> (ct, nct, eq, ne)</li>
     * <li><code>contactEmail</code> (ct, nct, eq, ne)</li>
     * <li><code>contactPhone</code> (ct, nct, eq, ne)</li>
     * <li><code>city</code> (ct, nct, eq, ne)</li>
     * <li><code>state</code> (in, nin, eq, ne)</li>
     ...
     * </ul>
     * <p>Example: name(ct)=hoa  return all records where name contains &quot;hoa&quot;</p>
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExportOrganizationsRequest && equalTo((ExportOrganizationsRequest) other);
    }
    ...
    private boolean equalTo(ExportOrganizationsRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ExportOrganizationsRequest other) {
        ...
        public ExportOrganizationsRequest build() {
            return new ExportOrganizationsRequest(
