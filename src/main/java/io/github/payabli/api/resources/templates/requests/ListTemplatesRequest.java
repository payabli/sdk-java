 ...
 */
package io.github.payabli.api.resources.templates.requests;
...
public final class ListTemplatesRequest {
     ...
     * <li><code>title</code> (ct, nct)</li>
     * <li><code>description</code> (ct, nct)</li>
     * <li><code>code</code> (ct, nct)</li>
     ...
     * </ul>
     * <p>Example: title(ct)=hoa return all records with title containing &quot;hoa&quot;</p>
     */
    ...
    public static final class Builder {
        ...
        public ListTemplatesRequest build() {
            return new ListTemplatesRequest(fromRecord, limitRecord, parameters, sortBy, additionalProperties);
        }
    }
}
