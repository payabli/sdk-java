...
public class AsyncRawNotificationClient {
     ...
     */
    public CompletableFuture<PayabliApiClientHttpResponse<PayabliApiResponseNotifications>> addNotification(
    ...
    public CompletableFuture<PayabliApiClientHttpResponse<PayabliApiResponseNotifications>> addNotification(
        ...
        CompletableFuture<PayabliApiClientHttpResponse<PayabliApiResponseNotifications>> future =
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new PayabliApiClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, PayabliApiResponseNotifications.class),
                                response));
                        return;
                    }
                    try {
     ...
     */
    public CompletableFuture<PayabliApiClientHttpResponse<NotificationQueryRecord>> getNotification(String nId) {
     ...
     * Retrieves a single notification or autogenerated report's details.
     */
    public CompletableFuture<PayabliApiClientHttpResponse<NotificationQueryRecord>> getNotification(
        ...
        CompletableFuture<PayabliApiClientHttpResponse<NotificationQueryRecord>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<PayabliApiClientHttpResponse<PayabliApiResponseNotifications>> updateNotification(
     ...
     */
    public CompletableFuture<PayabliApiClientHttpResponse<PayabliApiResponseNotifications>> deleteNotification(
            String nId) {
     ...
     */
    public CompletableFuture<PayabliApiClientHttpResponse<Map<String, Object>>> getReportFile(long id) {
     ...
     * Gets a copy of a generated report by ID.
     */
    public CompletableFuture<PayabliApiClientHttpResponse<Map<String, Object>>> getReportFile(
