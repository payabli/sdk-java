...
@JsonDeserialize(builder = ListPayoutSubscriptionsRequest.Builder.class)
public final class ListPayoutSubscriptionsRequest {
    ...
    private ListPayoutSubscriptionsRequest(
     ...
     * <p>For example:</p>
     * <p>--url https://api-sandbox.payabli.com/api/Query/payoutsubscriptions/entry123?parameters=totalAmount(gt)=1000&amp;limitRecord=20</p>
     * <p>should become:</p>
     * <p>--url https://api-sandbox.payabli.com/api/Query/payoutsubscriptions/entry123?totalAmount(gt)=1000&amp;limitRecord=20
     * &lt;/Info&gt;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListPayoutSubscriptionsRequest && equalTo((ListPayoutSubscriptionsRequest) other);
    }
    ...
    private boolean equalTo(ListPayoutSubscriptionsRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListPayoutSubscriptionsRequest other) {
        ...
        public ListPayoutSubscriptionsRequest build() {
            return new ListPayoutSubscriptionsRequest(
