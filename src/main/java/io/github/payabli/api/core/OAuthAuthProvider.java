...
public final class OAuthAuthProvider implements AuthProvider {
    ...
    public OAuthAuthProvider(
            Supplier<String> clientIdSupplier, Supplier<String> clientSecretSupplier, TokenClient authClient) {
    ...
    public static boolean canCreate(Supplier<String> clientIdSupplier, Supplier<String> clientSecretSupplier) {
        return (clientIdSupplier != null || System.getenv("OAUTH_CLIENT_ID") != null)
                && (clientSecretSupplier != null || System.getenv("OAUTH_CLIENT_SECRET") != null);
    }
}
