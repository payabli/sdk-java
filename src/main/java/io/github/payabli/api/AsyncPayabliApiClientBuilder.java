...
public class AsyncPayabliApiClientBuilder {
     ...
     * Sets apiKey
     */
    public AsyncPayabliApiClientBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public AsyncPayabliApiClientBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public AsyncPayabliApiClientBuilder url(String url) {
     ...
     */
    public AsyncPayabliApiClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncPayabliApiClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncPayabliApiClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public AsyncPayabliApiClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public AsyncPayabliApiClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public AsyncPayabliApiClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncPayabliApiClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncPayabliApiClientBuilder addHeader(String name, String value) {
    ...
    public static final class _TokenAuth extends AsyncPayabliApiClientBuilder {
    ...
    public static final class _CredentialsAuth extends AsyncPayabliApiClientBuilder {
        ...
        public AsyncPayabliApiClient build() {
            ...
            ClientOptions finalOptions = ClientOptions.Builder.from(baseOptions)
                    ...
                    .build();
            return new AsyncPayabliApiClient(finalOptions);
        }
    }
