...
public final class GetPayLinkFromIdResponse implements IPayabliApiResponseGeneric2Part {
    ...
    private final Optional<PayabliPages> responseData;
    ...
    private GetPayLinkFromIdResponse(
            ...
            String responseText,
            Optional<PayabliPages> responseData,
    ...
    public Optional<PayabliPages> getResponseData() {
        return responseData;
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage responseData(Optional<PayabliPages> responseData);

        _FinalStage responseData(PayabliPages responseData);
    }
    ...
    public static final class Builder implements ResponseTextStage, _FinalStage {
        ...
        private Optional<PayabliPages> responseData = Optional.empty();
        ...
        @java.lang.Override
        public _FinalStage responseData(PayabliPages responseData) {
        ...
        public _FinalStage responseData(Optional<PayabliPages> responseData) {
            this.responseData = responseData;
            return this;
        }
