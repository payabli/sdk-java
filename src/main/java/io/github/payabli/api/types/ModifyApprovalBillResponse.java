...
public final class ModifyApprovalBillResponse implements IPayabliApiResponseGeneric2Part {
    ...
    /**
     * @return If <code>isSuccess</code> = true, this contains the bill identifier. If
     * <code>isSuccess</code> = false, this contains the reason for the error.
     */
    ...
    public interface ResponseTextStage {
        ...
        Builder from(ModifyApprovalBillResponse other);
    }

    public interface _FinalStage {
        ModifyApprovalBillResponse build();
        ...
        /**
         * <p>If <code>isSuccess</code> = true, this contains the bill identifier. If
         * <code>isSuccess</code> = false, this contains the reason for the error.</p>
         */
