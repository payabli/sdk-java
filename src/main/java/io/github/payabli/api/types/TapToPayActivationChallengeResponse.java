...
@JsonDeserialize(builder = TapToPayActivationChallengeResponse.Builder.class)
public final class TapToPayActivationChallengeResponse {
    ...
    private final TapToPayActivationChallengeData responseData;

    private final Map<String, Object> additionalProperties;

    private TapToPayActivationChallengeResponse(
            Optional<Integer> responseCode,
            Optional<String> pageIdentifier,
            Optional<Long> roomId,
            Optional<Boolean> isSuccess,
            String responseText,
            TapToPayActivationChallengeData responseData,
    ...
    public TapToPayActivationChallengeData getResponseData() {
        return responseData;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TapToPayActivationChallengeResponse
                && equalTo((TapToPayActivationChallengeResponse) other);
    }
    ...
    private boolean equalTo(TapToPayActivationChallengeResponse other) {
    ...
    public interface ResponseTextStage {
        ...
        Builder from(TapToPayActivationChallengeResponse other);
    }

    public interface ResponseDataStage {
        _FinalStage responseData(@NotNull TapToPayActivationChallengeData responseData);
    }

    public interface _FinalStage {
        TapToPayActivationChallengeResponse build();
    ...
    public static final class Builder implements ResponseTextStage, ResponseDataStage, _FinalStage {
        ...
        private TapToPayActivationChallengeData responseData;
        ...
        @java.lang.Override
        public Builder from(TapToPayActivationChallengeResponse other) {
        ...
        public _FinalStage responseData(@NotNull TapToPayActivationChallengeData responseData) {
        ...
        @java.lang.Override
        public TapToPayActivationChallengeResponse build() {
            return new TapToPayActivationChallengeResponse(
