...
@JsonDeserialize(builder = GooglePayData.Builder.class)
public final class GooglePayData {
    private final Optional<GooglePayStatusData> data;
    ...
    private GooglePayData(
            Optional<GooglePayStatusData> data, Optional<Boolean> isEnabled, Map<String, Object> additionalProperties) {
        this.data = data;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GooglePayData && equalTo((GooglePayData) other);
    }
    ...
    private boolean equalTo(GooglePayData other) {
    ...
    public static final class Builder {
        private Optional<GooglePayStatusData> data = Optional.empty();
        ...
        public Builder from(GooglePayData other) {
            data(other.getData());
        ...
        public Builder data(GooglePayStatusData data) {
        ...
        public GooglePayData build() {
            return new GooglePayData(data, isEnabled, additionalProperties);
        }
    }
}
