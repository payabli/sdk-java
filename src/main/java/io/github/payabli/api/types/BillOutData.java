...
public final class BillOutData {
    ...
    private final Optional<BillOutDataVendor> vendor;
    ...
    private BillOutData(
            ...
            Optional<BillOutDataVendor> vendor,
    ...
    /**
     * @return An array of bill images. Attachments aren't required, but we strongly
     ...
     * file content, or you can include a <code>furl</code> to a public file. The maximum
     * file size for image uploads is 30 MB.
     * <p>When vendor enrichment is enabled and the first attachment is a PDF,
     ...
     * <a href="/guides/pay-out-vendor-enrichment-overview">vendor enrichment guide</a>
     * for details. Contact Payabli to enable this feature.</p>
     */
    ...
    /**
     * @return End date for scheduled bills. Applied only in <code>Mode</code> = 1. Accepted
    ...
    /**
     * @return The vendor associated with the bill. Although you can create a vendor
     * in a create bill request, Payabli recommends creating a vendor
     * separately and passing a valid <code>vendorNumber</code> here. At minimum, the
     * <code>vendorNumber</code> is required.
     */
    @JsonProperty("vendor")
    public Optional<BillOutDataVendor> getVendor() {
        return vendor;
    }
    ...
    public static final class Builder {
        ...
        private Optional<BillOutDataVendor> vendor = Optional.empty();
        ...
        /**
         * <p>An array of bill images. Attachments aren't required, but we strongly
         * recommend including them. Including a bill image can make payouts
         * smoother and prevent delays. You can include either the Base64-encoded
         * file content, or you can include a <code>furl</code> to a public file. The maximum
         * file size for image uploads is 30 MB.</p>
         * <p>When vendor enrichment is enabled and the first attachment is a PDF,
         * the invoice is scanned and extracted vendor contact information and
         * bill details (invoice number, amount due, due date) are merged into
         * the request. Fields in the request body take precedence over extracted
        ...
        /**
         * <p>End date for scheduled bills. Applied only in <code>Mode</code> = 1. Accepted
         * formats: YYYY-MM-DD, MM/DD/YYYY.</p>
         */
        ...
        /**
         * <p>The vendor associated with the bill. Although you can create a vendor
         * in a create bill request, Payabli recommends creating a vendor
         * separately and passing a valid <code>vendorNumber</code> here. At minimum, the
         * <code>vendorNumber</code> is required.</p>
         */
        @JsonSetter(value = "vendor", nulls = Nulls.SKIP)
        public Builder vendor(Optional<BillOutDataVendor> vendor) {
            this.vendor = vendor;
            return this;
        }

        public Builder vendor(BillOutDataVendor vendor) {
