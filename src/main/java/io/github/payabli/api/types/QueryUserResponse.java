...
@JsonDeserialize(builder = QueryUserResponse.Builder.class)
public final class QueryUserResponse {
    private final Optional<List<UserQueryRecord>> records;
    ...
    private QueryUserResponse(
            Optional<List<UserQueryRecord>> records,
    ...
    public Optional<List<UserQueryRecord>> getRecords() {
        return records;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof QueryUserResponse && equalTo((QueryUserResponse) other);
    }
    ...
    private boolean equalTo(QueryUserResponse other) {
    ...
    public static final class Builder {
        private Optional<List<UserQueryRecord>> records = Optional.empty();
        ...
        public Builder from(QueryUserResponse other) {
        ...
        public Builder records(Optional<List<UserQueryRecord>> records) {
            this.records = records;
            return this;
        }

        public Builder records(List<UserQueryRecord> records) {
        ...
        public QueryUserResponse build() {
            return new QueryUserResponse(records, summary, additionalProperties);
        }
    }
}
