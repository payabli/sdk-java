...
@JsonDeserialize(builder = VendorScheduleCallResponse.Builder.class)
public final class VendorScheduleCallResponse {
    ...
    private final Optional<VendorScheduleCallResponseData> responseData;

    private final Map<String, Object> additionalProperties;

    private VendorScheduleCallResponse(
            Optional<Integer> responseCode,
            Optional<String> pageIdentifier,
            Optional<Long> roomId,
            Optional<Boolean> isSuccess,
            String responseText,
            Optional<VendorScheduleCallResponseData> responseData,
    ...
    public Optional<VendorScheduleCallResponseData> getResponseData() {
        return responseData;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VendorScheduleCallResponse && equalTo((VendorScheduleCallResponse) other);
    }
    ...
    private boolean equalTo(VendorScheduleCallResponse other) {
    ...
    public interface ResponseTextStage {
        ...
        Builder from(VendorScheduleCallResponse other);
    }

    public interface _FinalStage {
        VendorScheduleCallResponse build();
        ...
        _FinalStage responseData(Optional<VendorScheduleCallResponseData> responseData);

        _FinalStage responseData(VendorScheduleCallResponseData responseData);
    }
    ...
    public static final class Builder implements ResponseTextStage, _FinalStage {
        ...
        private Optional<VendorScheduleCallResponseData> responseData = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(VendorScheduleCallResponse other) {
        ...
        @java.lang.Override
        public _FinalStage responseData(VendorScheduleCallResponseData responseData) {
        ...
        public _FinalStage responseData(Optional<VendorScheduleCallResponseData> responseData) {
            this.responseData = responseData;
            return this;
        }
        ...
        @java.lang.Override
        public VendorScheduleCallResponse build() {
            return new VendorScheduleCallResponse(
