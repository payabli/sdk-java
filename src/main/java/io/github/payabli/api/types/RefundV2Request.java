...
@JsonDeserialize(builder = RefundV2Request.Builder.class)
public final class RefundV2Request {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof RefundV2Request && equalTo((RefundV2Request) other);
    }
    ...
    private boolean equalTo(RefundV2Request other) {
    ...
    public int hashCode() {
        return Objects.hash(
                this.amount, this.ipaddress, this.orderDescription, this.orderId, this.refundDetails, this.source);
    }
    ...
    public static final class Builder {
        ...
        public Builder from(RefundV2Request other) {
        ...
        public RefundV2Request build() {
            return new RefundV2Request(
                    amount, ipaddress, orderDescription, orderId, refundDetails, source, additionalProperties);
        }
