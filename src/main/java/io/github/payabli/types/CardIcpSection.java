...
@JsonDeserialize(builder = CardIcpSection.Builder.class)
public final class CardIcpSection {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CardIcpSection && equalTo((CardIcpSection) other);
    }
    ...
    private boolean equalTo(CardIcpSection other) {
    ...
    public static final class Builder {
        ...
        public Builder from(CardIcpSection other) {
        ...
        public CardIcpSection build() {
            return new CardIcpSection(tiers, visible, additionalProperties);
        }
    }
}
