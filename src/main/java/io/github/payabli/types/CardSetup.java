...
public final class CardSetup implements ICardSetup {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CardSetup && equalTo((CardSetup) other);
    }
    ...
    private boolean equalTo(CardSetup other) {
    ...
    public static final class Builder {
        ...
        public Builder from(CardSetup other) {
        ...
        public CardSetup build() {
            return new CardSetup(acceptAmex, acceptDiscover, acceptMastercard, acceptVisa, additionalProperties);
        }
    }
}
