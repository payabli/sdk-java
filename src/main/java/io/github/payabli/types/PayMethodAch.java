...
@JsonDeserialize(builder = PayMethodAch.Builder.class)
public final class PayMethodAch {
    ...
    /**
     * @return Bank account type. This field is <strong>required</strong> when method = 'ach'.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PayMethodAch && equalTo((PayMethodAch) other);
    }
    ...
    private boolean equalTo(PayMethodAch other) {
    ...
    public interface AchAccountStage {
        ...
        Builder from(PayMethodAch other);
    }
    ...
    public static final class Builder implements AchAccountStage, AchHolderStage, AchRoutingStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(PayMethodAch other) {
        ...
        @java.lang.Override
        public PayMethodAch build() {
            return new PayMethodAch(
                    achAccount,
                    achAccountType,
                    achCode,
                    achHolder,
