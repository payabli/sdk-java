...
@JsonDeserialize(builder = BoardingApplicationAttachments.Builder.class)
public final class BoardingApplicationAttachments {
    ...
    private BoardingApplicationAttachments(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BoardingApplicationAttachments && equalTo((BoardingApplicationAttachments) other);
    }
    ...
    private boolean equalTo(BoardingApplicationAttachments other) {
    ...
    public static final class Builder {
        ...
        public Builder from(BoardingApplicationAttachments other) {
        ...
        public BoardingApplicationAttachments build() {
            return new BoardingApplicationAttachments(filelist, zipfile, additionalProperties);
        }
    }
}
