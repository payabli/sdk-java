...
@JsonDeserialize(builder = AssociatedVendor.Builder.class)
public final class AssociatedVendor {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AssociatedVendor && equalTo((AssociatedVendor) other);
    }
    ...
    private boolean equalTo(AssociatedVendor other) {
    ...
    public static final class Builder {
        ...
        public Builder from(AssociatedVendor other) {
        ...
        public AssociatedVendor build() {
            return new AssociatedVendor(
                    vendorNumber,
                    name1,
                    name2,
                    ein,
