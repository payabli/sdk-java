...
@JsonDeserialize(builder = SignerDataRequest.Builder.class)
public final class SignerDataRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SignerDataRequest && equalTo((SignerDataRequest) other);
    }
    ...
    private boolean equalTo(SignerDataRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(SignerDataRequest other) {
            name(other.getName());
            ssn(other.getSsn());
            dob(other.getDob());
        ...
        public SignerDataRequest build() {
            return new SignerDataRequest(
                    name,
                    ssn,
                    dob,
                    phone,
