...
@JsonDeserialize(builder = ListBillsOrgRequest.Builder.class)
public final class ListBillsOrgRequest {
     ...
     * <li><code>approvalUserId</code> (eq, ne)</li>
     * <li><code>approvalUserEmail</code> (eq, ne)</li>
     * </ul>
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListBillsOrgRequest && equalTo((ListBillsOrgRequest) other);
    }
    ...
    private boolean equalTo(ListBillsOrgRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListBillsOrgRequest other) {
        ...
        public ListBillsOrgRequest build() {
            return new ListBillsOrgRequest(
